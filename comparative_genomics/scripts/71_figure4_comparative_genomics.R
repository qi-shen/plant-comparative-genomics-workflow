...
species_latin <- c(
  ...
  C04 = "A. palmeri", O01 = "A. thaliana", C05 = "C. C05",
  C06 = "D. caryophyllus", C08 = "F. multiflora",
  C07 = "G. paniculata", C09 = "H. ammodendron", C10 = "P. oleracea",
  C11 = "S. monacanthus", O02 = "V. vinifera"
)
...
petal_sp <- c("T01", "T02", "C02", "C03", "C01", "C08")
petal_labels <- c(
  T01 = "T. sp. T01", T02 = "T. sp. T02",
  C02 = "T. austromongolica", C03 = "T. C03",
  C01 = "R. soongarica", C08 = "F. multiflora"
)
...
# 花瓣颜色
petal_colors <- c(
  T01 = palette14[1], T02 = palette14[2], C02 = palette14[3],
  C03 = palette14[4], C01 = palette14[5], C08 = palette14[8]
)
