...
def main():
    paml_dir = "${PROJECT_ROOT}/comparative_genomics/06_selection/paml_alignments"
    output_file = "${PROJECT_ROOT}/comparative_genomics/06_selection/paml_results_summary.tsv"
    ...
    # 保存正选择基因列表
    if len(positive_selection) > 0:
        ps_output = "${PROJECT_ROOT}/comparative_genomics/06_selection/positive_selection_genes.tsv"
