...
# 定义物种数据
declare -A PEP_FILES=(
    ["BH"]="$BASE_DIR/comparative_genomics/01_proteomes/filtered/BH.fa"
    ["CK"]="$BASE_DIR/comparative_genomics/01_proteomes/filtered/CK.fa"
    ["TAU"]="$BASE_DIR/comparative_genomics/01_proteomes/filtered/TAU.fa"
)
