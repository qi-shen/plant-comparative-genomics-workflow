...
cat("## 输出文件\n\n", file = report_file, append = TRUE)
cat("### BH样本\n\n", file = report_file, append = TRUE)
cat("- 更新后的注释GFF3: `annotation/T01/pasa_update/BH_pasa.pasa_assemblies.gff3`\n", file = report_file, append = TRUE)
cat("- 更新后的注释GTF: `annotation/T01/pasa_update/BH_pasa.pasa_assemblies.gtf`\n", file = report_file, append = TRUE)
cat("- 组装序列: `annotation/T01/pasa_update/BH_pasa.assemblies.fasta`\n", file = report_file, append = TRUE)
cat("- 更新后的蛋白质序列: `annotation/T01/pasa_update/BH_pasa_updated_filtered.pep.fa`\n\n", file = report_file, append = TRUE)

cat("### CK样本\n\n", file = report_file, append = TRUE)
cat("- 更新后的注释GFF3: `annotation/T02/pasa_update/CK_pasa.pasa_assemblies.gff3`\n", file = report_file, append = TRUE)
cat("- 更新后的注释GTF: `annotation/T02/pasa_update/CK_pasa.pasa_assemblies.gtf`\n", file = report_file, append = TRUE)
cat("- 组装序列: `annotation/T02/pasa_update/CK_pasa.assemblies.fasta`\n", file = report_file, append = TRUE)
cat("- 更新后的蛋白质序列: `annotation/T02/pasa_update/CK_pasa_updated_filtered.pep.fa`\n\n", file = report_file, append = TRUE)
