...
WORK_DIR="$BASE_DIR/old_reults/comparative_genomics/06_selection"
OF_DIR="$BASE_DIR/old_reults/comparative_genomics/02_orthofinder_results/Results_Dec29/WorkingDirectory/OrthoFinder/Results_Dec29_1"
