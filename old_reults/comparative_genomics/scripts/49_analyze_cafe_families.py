...
def load_orthofinder_results():
    """加载OrthoFinder结果"""
    ortho_dir = "/path/to/project_root/comparative_genomics/02_orthofinder"
...
def analyze_cafe_families():
    """分析CAFE显著变化家族"""
    cafe_dir = "/path/to/project_root/comparative_genomics/07_cafe"
    output_dir = "/path/to/project_root/comparative_genomics/07_cafe"
