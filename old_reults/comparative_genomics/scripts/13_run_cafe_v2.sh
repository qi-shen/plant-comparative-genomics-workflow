...
# 查找OrthoFinder结果目录
RESULTS_DIR=$(ls -td "$OF_DIR" 2>/dev/null | head -1)
...
# 读取基因家族计数表
og_counts = pd.read_csv('/path/to/project_root/comparative_genomics/02_orthofinder_results/Results_Dec29/WorkingDirectory/OrthoFinder/Results_Dec29_1/Orthogroups/Orthogroups.GeneCount.tsv', sep='\t')
