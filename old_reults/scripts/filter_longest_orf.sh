...
SPECIES=$1
INPUT_PEP="/path/to/project_root/annotation/${SPECIES}/pasa_update/${SPECIES}_pasa_updated.pep.fa"
OUTPUT_PEP="/path/to/project_root/annotation/${SPECIES}/pasa_update/${SPECIES}_pasa_updated_filtered.pep.fa"
