...
PASA_HOME="/home/shenq/miniconda3/envs/pasa/opt/pasa-2.4.1"
...
# 使用PASA的模板创建配置文件
TEMPLATE_FILE="/home/shenq/miniconda3/envs/pasa/opt/pasa-2.4.1/pasa_conf/pasa.alignAssembly.Template.txt"
