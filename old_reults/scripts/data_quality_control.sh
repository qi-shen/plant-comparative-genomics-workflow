...
main() {
    ...
    # C02
    species_data["C02"]="C02:tau_genome.fasta:tau.gff3:tau.longest_cds.fasta:tau.longest_pep.fasta"
    
    # C03
    species_data["C03"]="C03:Tchinensis.fasta:Tchinensis.gff3:Tchinensis_cds.fa:Tchinensis_pep.fa"
    
    # C05
    species_data["C05"]="C05:0321072RM_v1.fasta:0321072RM_v1.gff3:0321072RM_v1-cds.fasta:0321072RM_v1-prot.fasta"
    
    # C07
    species_data["C07"]="C07:Gpan_WG.chromosome.fasta:Gpan_WG.gff:Gpan_WG.cds:Gpan_WG.pep"
