...
BUSCO_BASE_DIR="/path/to/project_root/annotation/evaluation/busco_updated"
LOG_DIR="/path/to/project_root/logs"
LINEAGE_PATH="/path/to/project_root/busco_downloads/lineages/embryophyta_odb10"
THREADS=32
...
species_peps[BH]="/path/to/project_root/annotation/BH/pasa_update/BH_pasa_updated_filtered.pep.fa"
species_peps[CK]="/path/to/project_root/annotation/CK/pasa_update/CK_pasa_updated_filtered.pep.fa"
