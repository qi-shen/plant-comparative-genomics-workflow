...
check_eggnog() {
    if command -v emapper.py &> /dev/null; then
        ...
        return 0
    elif [ -f "/home/shenq/Biosofts/eggnog-mapper/emapper.py" ]; then
        EGGNOG="/home/shenq/Biosofts/eggnog-mapper/emapper.py"
        log_info "使用eggNOG-mapper: $EGGNOG"
        return 0
    else
...
run_eggnog() {
    ...
    if [ -d "/home/shenq/Biosofts/eggnog-mapper/data" ]; then
        eggnog_data_dir="/home/shenq/Biosofts/eggnog-mapper/data"
